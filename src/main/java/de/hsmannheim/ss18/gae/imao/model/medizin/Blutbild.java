...
public class Blutbild {
    ...
    private static final double KRANK_ERYTHROZYTEN_FRAU_ERHOET_LEICHT = DEFAULT_MAX_FRAU_ERYTHROZYTEN
            + ((DEFAULT_MAX_FRAU_ERYTHROZYTEN - DEFAULT_MIN_FRAU_ERYTHROZYTEN) * 0.1);
    private static final double KRANK_ERYTHROZYTEN_FRAU_ERHOET_STARK = DEFAULT_MAX_FRAU_ERYTHROZYTEN
            + ((DEFAULT_MAX_FRAU_ERYTHROZYTEN - DEFAULT_MIN_FRAU_ERYTHROZYTEN) * 0.25);

    private static final double KRANK_ERYTHROZYTEN_FRAU_GERING_LEICHT = DEFAULT_MIN_FRAU_ERYTHROZYTEN
            - ((DEFAULT_MAX_FRAU_ERYTHROZYTEN - DEFAULT_MIN_FRAU_ERYTHROZYTEN) * 0.1);
    private static final double KRANK_ERYTHROZYTEN_FRAU_GERING_STARK = DEFAULT_MIN_FRAU_ERYTHROZYTEN
            - (DEFAULT_MAX_FRAU_ERYTHROZYTEN - DEFAULT_MIN_FRAU_ERYTHROZYTEN) * 0.25;

    // grenzwerte Haemoglobinkonzentration Mann
    private static final double KRANK_ERYTHROZYTEN_MANN_ERHOET_LEICHT = DEFAULT_MAX_MANN_ERYTHROZYTEN
            + ((DEFAULT_MAX_MANN_ERYTHROZYTEN- DEFAULT_MIN_MANN_ERYTHROZYTEN) * 0.1);
    private static final double KRANK_ERYTHROZYTEN_MANN_ERHOET_STARK = DEFAULT_MAX_MANN_ERYTHROZYTEN
            + ((DEFAULT_MAX_MANN_ERYTHROZYTEN - DEFAULT_MIN_MANN_ERYTHROZYTEN) * 0.25);

    private static final double KRANK_ERYTHROZYTEN_MANN_GERING_LEICHT = DEFAULT_MIN_MANN_ERYTHROZYTEN
            - ((DEFAULT_MAX_MANN_ERYTHROZYTEN - DEFAULT_MIN_MANN_ERYTHROZYTEN) * 0.1);
    private static final double KRANK_ERYTHROZYTEN_MANN_GERING_STARK = DEFAULT_MIN_MANN_ERYTHROZYTEN
            - (DEFAULT_MAX_MANN_ERYTHROZYTEN - DEFAULT_MIN_MANN_ERYTHROZYTEN) * 0.25;
...
//		this.krankheit = krankheit;
    ...
    private void erstelleNormalesBlutbild(EGeschlecht gender) {
        ...
        if (gender == EGeschlecht.MAENNLICH) {
            this.Haemoglobinkonzentration = random(DEFAULT_MIN_MANN_ERYTHROZYTEN, DEFAULT_MAX_MANN_ERYTHROZYTEN);
            ...
            this.Haemoglobinkonzentration = random(DEFAULT_MIN_FRAU_ERYTHROZYTEN, DEFAULT_MAX_FRAU_ERYTHROZYTEN);
    ...
    public String toString() {
        ...
        objectNode.put("Erythrozyten", this.Haemoglobinkonzentration);
        if (this.geschlecht.equals(EGeschlecht.MAENNLICH)) {
            objectNode.put("Erythrozyten_min_normal", DEFAULT_MIN_MANN_ERYTHROZYTEN);
            objectNode.put("Erythrozyten_max_normal", DEFAULT_MAX_MANN_ERYTHROZYTEN);
            objectNode.put("Erythrozyten_min_veringert", KRANK_ERYTHROZYTEN_MANN_GERING_LEICHT);
            objectNode.put("Erythrozyten_max_veringert", KRANK_ERYTHROZYTEN_MANN_GERING_STARK);
            objectNode.put("Erythrozyten_min_erhoeht", KRANK_ERYTHROZYTEN_MANN_ERHOET_LEICHT);
            objectNode.put("Erythrozyten_max_erhoeht", KRANK_ERYTHROZYTEN_MANN_ERHOET_STARK);
        } else {
            objectNode.put("Erythrozyten_min_normal", DEFAULT_MIN_FRAU_ERYTHROZYTEN);
            objectNode.put("Erythrozyten_max_normal", DEFAULT_MAX_FRAU_ERYTHROZYTEN);
            objectNode.put("Erythrozyten_min_veringert", KRANK_ERYTHROZYTEN_FRAU_GERING_LEICHT);
            objectNode.put("Erythrozyten_max_veringert", KRANK_ERYTHROZYTEN_FRAU_GERING_STARK);
            objectNode.put("Erythrozyten_min_erhoeht", KRANK_ERYTHROZYTEN_FRAU_ERHOET_LEICHT);
            objectNode.put("Erythrozyten_max_erhoeht", KRANK_ERYTHROZYTEN_FRAU_ERHOET_STARK);
        }
