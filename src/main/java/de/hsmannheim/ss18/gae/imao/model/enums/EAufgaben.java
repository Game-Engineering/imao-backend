...
public enum EAufgaben {
	KEINE("Sehr geehrter IMAO Vorstand,\n"
			+ "ich habe momentan keine Aufgabe für Sie, arbeiten Sie einfach weiter."), INTERVIEW(
					"Sehr geehrter IMAO Vorstand,\n"
	...
	, SPONSOR_ANWERBEN("Sehr geehrter IMAO Vorstand,\n"
			+ "Für den Unterhalt und die Gehälter der IMAO Mitarbeiter benötigen wir finanzielle Mittel. "
			+ "Sorgen sie dafür, dass ein Sponsor sich verpflichtend unsere Organisation finanziell zu unterstützen."), ARZT_ABMAHNEN(
					"Sehr geehrter IMAO Vorstand,\n"
							+ "aufgrund mangelnder Erfolgsquote bei den Behandlungen der Patienten im Camp ist es an der Zeit den Arzt abzumahnen. "
							+ "Bei den Fehlbehandlungen scheint es sich ausschließlch um Arztfehler zu handeln und dies wirft ein schlechtes Licht auf die gesamte Organisation.");
